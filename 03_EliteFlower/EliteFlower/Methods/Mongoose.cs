...
namespace EliteFlower.Methods
{
    public static class Mongoose
    {
        ...
        public static void SetVase2Stage(int valueBalance)
        {
            ...
            IMongoCollection<BalanceName> BalanceNameDB = database.GetCollection<BalanceName>("BWorkName");
            //MessageBox.Show("balanceo");
            IMongoCollection<BalanceCount> BalanceQuantityDB = database.GetCollection<BalanceCount>("BWorkQuantity");
            //MessageBox.Show("cantidades");
            ...
            //Console.WriteLine(balanceUUID);
            // MessageBox.Show("reemplazando cantidades");
            ...
            //MessageBox.Show("balance Names"+ balanceNames.Count.ToString() + "\nstages lenght" +stages.ToString());
            int contador = 0;
        ...
        public static (int, int, int, int, int) GetValuesPLC()
        {
            ...
            if (lst.Count > 0)
            {
                return (
                    (int)lst[0].timeLed,
                    (int)lst[0].velocityMotor1,
                    (int)lst[0].velocityMotor2,
                    (int)lst[0].percentageMotor1,
                    (int)lst[0].percentageMotor2
                );
            }
            return (1000, 2048, 2048, 100, 100);
        }
